...
class HotfixViewCodeGenerator {
    Handle(handler) {
        ...
        // 从自定义配置中读取路径和命名空间
        let HotfixViewExportCodePath = CodeGenConfig_1.CodeGenConfig.HotfixViewCodeOutputPath + '/' + codePkgName;
        let ModelViewExportCodePath = CodeGenConfig_1.CodeGenConfig.ModelViewCodeOutputPath + '/' + codePkgName;
        let namespaceName = CodeGenConfig_1.CodeGenConfig.HotfixNameSpace;
        // 初始化自定义组件名前缀
