...
namespace cfg
{
    public sealed partial class ItemConfig: Bright.Config.BeanBase
    {
        ...
        public ItemConfig UpgradeToItemId_Ref { get; private set; }
        /// <summary>
        /// 过期时间
        /// </summary>
        ...
        {
            this.UpgradeToItemId_Ref = (_tables["ItemConfigCategory"] as ItemConfigCategory).GetOrDefault(UpgradeToItemId);
